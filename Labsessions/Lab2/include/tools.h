 ...
 * results is stored in res.
 * The size of the arrays should be m x n
 *
 * **********************************************/
void
...
/* **********************************************
 *
 * Add const with every element in A
 * results is stored in res.
 * The size of the arrays should be n x m 
 *
 * **********************************************/
void
...
/* **********************************************
 *
 * Multiply const with every element in A
 * results is stored in res.
 * The length of the arrays should be n x m
 *
 * **********************************************/
void
